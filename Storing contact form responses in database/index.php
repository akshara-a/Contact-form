...
<body>
    ...
    <form method="post" name="contact_form" action="">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="exampleFormControlInput1" name="petname" required>
        </div>
        <div class="mb-3">
            <label class="form-label">Which breed does it belong to?</label>
            <input type="text" class="form-control" id="exampleFormControlInput1" name="breed" required>
        </div>
        <div class="mb-3">
